...
What's New?
===========
1. WebLogic Web Server Plug-in has removed support for TLS1.0 SSL protocol. 
   Plug-in will fail to connect to WebLogic server when TLS1.0 SSL protocol is 
   configured for SSL communication.

2. WebLogic Web Server Plug-In considers MD5 signed certificates as insecure,
...
3. WebLogic Web Server Plug-In 12c supports Apache HTTP Server 2.4.x
...
4. WebLogic Server 12.1.2 support deploying WebSocket applications. 
...
5. Following WebLogic Web Server Plug-In configuration parameters are now 
   introduced:
...
6. WebLogic Web Server Plug-In for Apache HTTP Server and Oracle iPlanet 
...
WebLogic Server Plugin version 12.2.1.3.0, <WLSPLUGINS_XXXX_XXXX_XXXXX.XXXX>
